...
export default function Footer() {
  ...
  function handleClick(e: React.MouseEvent, href: string) {
    ...
    if (hash) { e.preventDefault(); handleHashNav(hash); }
  }
      ...
      <div className="vt-footer-grid">
        <div className="vt-footer-col vt-footer-about">
          ...
          <div className="vt-footer-social">
            <a href="https://www.linkedin.com/company/venmertech/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
        ...
        <div className="vt-footer-col">
          ...
          <ul className="vt-footer-list">
            {SERVICE_LINKS.map((s) => (
              <li key={s}>
                <a href="/#services" onClick={(e) => handleClick(e, "/#services")}>{s}</a>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="vt-footer-col">
          ...
          <ul className="vt-footer-list vt-footer-contact">
            <li>1900 Yorktown St, #508<br />Houston, TX 77056<br />United States</li>
            <li><a href="tel:+19402631641">Phone: +1(940)263.1641</a></li>
            <li><a href="mailto:info@cognillc.com">Email: info@cognillc.com</a></li>
          </ul>
        </div>
      </div>
